...
Le \textbf{comunicazioni interne} sono principalmente tra studenti del gruppo e sono conversazioni tra pari. Dipendentemente dal canale di comunicazione scelto, per favorire la produttività, bisognerà adottare un registro adeguato e seguire le convenzioni decise (consultare la sezione \underline{\ref{sec:Infrastruttura} \nameref{sec:Infrastruttura}} per più informazioni sugli strumenti di organizzazione utilizzati):
\begin{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
  \item \textbf{\textit{Amministratore}}: ha il ruolo di garantire l'efficacia e l'efficienza dei processi, in particolare:
  \begin{itemize}
  ...
  \end{itemize}
  \item \textbf{\textit{Progettista}}: ha il compito di modellare i requisiti individuati nella fase di analisi e ricomporli in un'architettura che possa soddisfarli. Nello specifico si occupa di:
  \begin{itemize}
