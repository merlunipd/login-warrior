...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{\textit{Specifica Architetturale}:} espone e descrive le scelte progettuali effettuate nella realizzazione del prodotto, attraverso diagrammi delle classi e di sequenza, scelta di design pattern e loro contestualizzazione al prodotto.
    \end{itemize}
