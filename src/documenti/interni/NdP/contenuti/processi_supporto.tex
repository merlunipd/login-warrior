...
\newline
Vogliamo inoltre poter ottenere una miglioramento continuo della nostra
qualità, grazie alla visione del nostro andamento e tramite verifiche retrospettive.
...
\begin{itemize}
    \item Assicurarci della qualità del prodotto che realizzato;
    ...
    \item Poterci migliorare progressivamente per non ripete gli stessi errori
