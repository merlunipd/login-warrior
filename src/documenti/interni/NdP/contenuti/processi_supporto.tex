...
\begin{itemize}
    ...
    \item \textbf{Approvazione:} terminata la verifica di tutte le sezioni il \textit{Responsabile} rilegge il documento e decide se approvarlo o meno; se approvato viene pubblicato nel repository altrimenti si torna alla fase di verifica.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{\textit{Piano di Progetto}:} espone la pianificazione di tutte le attività di progetto previste, presentando una previsione dell’impegno orario e un preventivo delle spese. Documento esterno;
