...
\subsection{Immagini}
Le immagini sono contenute nella cartella chiamata \texttt{immagini} che a sua volta è contenuta nella cartella del documento a cui si riferiscono. Verranno poi richiamate dentro i file \LaTeX{} ove servono. Sia i diagrammi UML$_G$ che i diagrammi di Gantt$_G$ vengono riportati come immagini.
