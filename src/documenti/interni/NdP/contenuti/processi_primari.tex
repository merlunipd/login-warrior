...
\subsection{Descrizione}
  ...
  \subsection{Analisi dei requisiti}
    L'analisi dei requisiti è quell'attività che precede lo sviluppo e ha la funzione di:
    \begin{itemize}
  ...
  \begin{itemize}
    \item \textbf{Progettazione logica:} motiva le tecnologie, i framework e le librerie usate per la realizzazione di un prodotto, dimostrandone l'adeguatezza nel PoC.
    \\Contiene:
    \begin{itemize}
