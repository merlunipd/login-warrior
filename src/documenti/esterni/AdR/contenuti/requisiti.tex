...
Il gruppo \textit{MERL} dopo un'attenta analisi ha individuato i seguenti requisiti che il prodotto finale andrà a soddisfare. Questi sono organizzati in forma tabellare e la loro struttura segue le regole definite nel documento \textit{Norme di Progetto V3.0.0}.
...
\begin{center}
  ...
  \begin{longtable}{|L{2cm}|C{5,5cm}|C{3cm}|C{2cm}|}
    ...
    \rowcolor[HTML]{EFEFEF}
    RQ.1.5 & Il prodotto deve essere sviluppato seguendo le \textit{Norme di Progetto V3.0.0} & Obbligatorio & \textit{Norme di Progetto V3.0.0} \\ \hline
...
\begin{center}
  ...
  \begin{longtable}{|C{6cm}|C{6cm}|}
    ...
    UC9 & RF.2.9 \\ \hline
    \rowcolor[HTML]{EFEFEF}
    \textit{Norme di Progetto V3.0.0} & RQ.1.5 \\ \hline
    \rowcolor[HTML]{C0C0C0}
...
\begin{center}
  ...
  \begin{longtable}{|C{6cm}|C{6cm}|}
    ...
    \rowcolor[HTML]{EFEFEF}
    RQ.1.5 & \textit{Norme di Progetto V3.0.0} \\ \hline
    \rowcolor[HTML]{C0C0C0}
