...
\begin{center}
  ...
  \begin{longtable}{|L{1,5cm}|C{5,5cm}|C{3cm}|C{2cm}|}
    ...
    \rowcolor[HTML]{C0C0C0}
    RF.2.6.4.1 & L'utente deve poter scegliere la colorazione dei link & Desiderabile & UC6.4 \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RF.2.6.4.2 & L'utente deve poter scegliere l'opacità dei link & Desiderabile & UC6.4 \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RF.2.6.4.3 & L'utente deve poter scegliere l'allinamento dei link & Desiderabile & UC6.4 \\ \hline
    \rowcolor[HTML]{C0C0C0}
...
\begin{center}
  ...
  \begin{longtable}{|C{6cm}|C{6cm}|}
    ...
    \rowcolor[HTML]{C0C0C0}
    UC6.4 & RF.1.6.4.1 RF.1.6.4.2 RF.2.6.4.3  \\ \hline
    \rowcolor[HTML]{EFEFEF}
    UC7 & RF.2.7 \\ \hline
    \rowcolor[HTML]{C0C0C0}
