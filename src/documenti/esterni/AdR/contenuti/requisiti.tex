...
\begin{center}
  ...
  \begin{longtable}{|L{2cm}|C{5,5cm}|C{3cm}|C{2cm}|}
    ...
    \rowcolor[HTML]{C0C0C0}
    RF.1.6 & L'utente deve poter personalizzare la visualizzazione scelta & Obbligatorio & UC6 \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RF.2.6.3.1 & L'utente deve poter scegliere la funzione di forza & Desiderabile & UC6.3 \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RF.1.6.3.2 & L'utente deve poter scegliere l'intensità delle forze di tensione e repulsione & Obbligatorio & UC6.3 \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RF.1.6.3.3 & L'utente deve poter scegliere gli stili per la visualizzazione del grafico & Obbligatorio & UC6.3 \\ \hline
    \rowcolor[HTML]{C0C0C0}
...
\begin{center}
  ...
  \begin{longtable}{|C{6cm}|C{6cm}|}
    ...
    UC6 & RF.1.6 \\ \hline
    \rowcolor[HTML]{C0C0C0}
    UC6.3 & RF.2.6.3.1 RF.1.6.3.2 RF.1.6.3.3  \\ \hline
    \rowcolor[HTML]{EFEFEF}
    UC7 & RF.1.7 \\ \hline
    \rowcolor[HTML]{C0C0C0}
    UC8 & RF.2.8 \\ \hline
...
\begin{center}
  ...
  \begin{longtable}{|C{6cm}|C{6cm}|}
    ...
    \rowcolor[HTML]{C0C0C0}
    RF.1.6.3.2 & UC6.3 \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RF.1.6.3.3 & UC6.3 \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RF.1.7 & UC7 \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RF.2.8 & UC9 \\ \hline
