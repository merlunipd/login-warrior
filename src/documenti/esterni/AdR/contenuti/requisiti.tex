...
\begin{center}
  ...
  \begin{longtable}{|L{2cm}|C{5,5cm}|C{3cm}|C{2cm}|}
    ...
    \rowcolor[HTML]{EFEFEF}
    RF ? & L'utente deve poter cambiare l'opacità in un grafico \textit{Parallel Coordinates} & Desiderabile & UC ? \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RF ? & L'utente deve poter cambiare la curvatura e la forza di raggruppamento delle linee in un grafico \textit{Parallel Coordinates} & Desiderabile & UC ? \\ \hline
    \rowcolor[HTML]{EFEFEF}
