...
Il gruppo \textit{MERL} dopo un'attenta analisi ha individuato i seguenti requisiti che il prodotto finale andrà a soddisfare. Questi sono organizzati in forma tabellare e la loro struttura segue le regole definite nel documento \textit{Norme di Progetto V2.0.0}.
...
\begin{center}
  ...
  \begin{longtable}{|L{2cm}|C{5,5cm}|C{3cm}|C{2cm}|}
    ...
    \rowcolor[HTML]{EFEFEF}
    RQ.1.5 & Il prodotto deve essere sviluppato seguendo le \textit{Norme di Progetto V2.0.0} & Obbligatorio & \textit{Norme di Progetto V2.0.0} \\ \hline
...
\begin{center}
  ...
  \begin{longtable}{|L{2cm}|C{5,5cm}|C{3cm}|C{2cm}|}
    ...
    \rowcolor[HTML]{EFEFEF}
    RV.1.5 & Il prodotto finale deve essere supportato dal browser \textit{Chrome 61} & Obbligatorio & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RV.1.6 & Il prodotto finale deve essere supportato dal browser \textit{Edge 16} & Obbligatorio & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RV.1.7 & Il prodotto finale deve essere supportato dal browser \textit{Firefox 60} & Obbligatorio & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RV.1.8 & Il prodotto finale deve essere supportato dal browser \textit{Opera 48} & Obbligatorio & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RV.1.9 & Il prodotto finale deve essere supportato dal browser \textit{Safari 10.1} & Obbligatorio & \textit{Javascript Modules} \\ \hline
...
\begin{center}
  ...
  \begin{longtable}{|C{6cm}|C{6cm}|}
    ...
    UC9 & RF.2.9 \\ \hline
    \rowcolor[HTML]{EFEFEF}
    \textit{Norme di Progetto V2.0.0} & RQ.1.5 \\ \hline
    \rowcolor[HTML]{C0C0C0}
    \textit{Javascript Modules} & RV.1.5 - RV.1.6 - RV.1.7 - RV.1.8 - RV.1.9 \\ \hline
...
\begin{center}
  ...
  \begin{longtable}{|C{6cm}|C{6cm}|}
    ...
    \rowcolor[HTML]{EFEFEF}
    RQ.1.5 & \textit{Norme di Progetto V2.0.0} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    ...
    \rowcolor[HTML]{C0C0C0}
    RV.1.5 & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RV.1.6 & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RV.1.7 & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    RV.1.8 & \textit{Javascript Modules} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RV.1.9 & \textit{Javascript Modules} \\ \hline
