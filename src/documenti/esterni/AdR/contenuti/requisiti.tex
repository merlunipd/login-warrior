...
\begin{center}
  ...
  \begin{longtable}{|L{1,5cm}|C{5,5cm}|C{3cm}|C{2cm}|}
    ...
    \rowcolor[HTML]{EFEFEF}
    RF.2.6.1.1 & L'utente deve poter modificare la visualizzazione dei punti & Desiderabile & UC6.1 \\ \hline
    \rowcolor[HTML]{C0C0C0}
    RF.2.6.1.2 & L'utente deve poter scegliere i colori  & Desiderabile & UC6.1 \\ \hline
    \rowcolor[HTML]{EFEFEF}
