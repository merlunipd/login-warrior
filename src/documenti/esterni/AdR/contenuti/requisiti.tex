...
\todo{RQ.1.5, va bene la fonte "Norme di Progetto"?} \\
\todo{Il gruppo del PoC ha qualcosa in merito ai requisiti prestazionali o possiamo lasciare così? Inoltre ci sono aggiunte da fare per quanto riguarda i requisiti funzionali per la personalizzazione del grafico?}
