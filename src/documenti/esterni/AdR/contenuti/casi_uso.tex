...
\begin{itemize}
    ...
    \begin{enumerate}
      \item Selezionare la funzione di forza [UC6.3.1];
      \item Selezionare l'intensità delle forze di repulsione e tensione [UC6.3.2];
  ...
  \subsubsection{UC6.3.2 - Selezione intensità delle forze di repulsione e tensione}
  \begin{itemize}
