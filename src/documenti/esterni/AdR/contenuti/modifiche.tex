...
\begin{longtable}{|C{1.8cm}|C{2.1cm}|C{2cm}|C{2.4cm}|L{4.4cm}|}
  ...
  \rowcolor[HTML]{C0C0C0}
  v0.0.18          & 05/03/2022    & Riccardo Contin  &          & Modifiche sezione "UC6"                        \\ \hline
  \rowcolor[HTML]{EFEFEF}
  v0.0.17          & 05/03/2022    & Marco Mamprin  &          & Modifiche sezione "UC6"                        \\ \hline
  \rowcolor[HTML]{C0C0C0}
  v0.0.16          & 05/03/2022    & Marco Mazzucato  &          & Modifiche sezione "UC6"                        \\ \hline
  \rowcolor[HTML]{EFEFEF}
