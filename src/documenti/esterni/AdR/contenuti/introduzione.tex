...
requisiti, individuati tramite la presentazione del capitolato e tramite gli incontro con il proponente, grazie ai quali
possiamo capire i vari attori del sistema e illustrare i diversi casi d'uso relativi al prodotto software.
\newline
Inoltre questo documento fornisce anche supporto ai progettisti, poiché fornisce una chiara idea sui vari componenti del programma.

\section{Introduzione ai Casi d'Uso}
\subsection{Scopo}
L'obiettivo è quello di elencare tutti i casi d'uso individuati dl gruppo, per poterli analizzare uno a uno e capirli al meglio, per 
ogni caso d'uso troviamo:
\begin{itemize}
...
come un amministratore o un utente registrato, perciò sarà presente solo attore all'interno del sistema: un utente generico, che avrà accesso a tutte
