...
\begin{itemize}
  \item Un \textbf{utente}, che avrà accesso a tutte le funzionalità del prodotto.
  \item Uno \textbf{sviluppatore}, che è generalizzato dall'utente e può, inoltre, accedere al codice del software, per eventuali modifiche.
\end{itemize} 
\begin{figure}[h]
  \centering
  \includegraphics[width=0.3\textwidth]{attori}
