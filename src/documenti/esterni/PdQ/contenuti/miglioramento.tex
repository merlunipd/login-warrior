...
\begin{table}[H]
   ...
   \hline
    ...
    {\color[HTML]{FFFFFF} \textbf{Problema}} & {\color[HTML]{FFFFFF} \textbf{Gravità}} & {\color[HTML]{FFFFFF} \textbf{Descrizione}} & {\color[HTML]{FFFFFF} \textbf{Soluzione}} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    Responsabile & Media & Inizialmente il gruppo ha incontrato svariate difficoltà nella distribuzione delle ore e nel suddividere equamente i compiti. & Il gruppo ha deciso di puntare a previsioni di più breve durata in modo da riuscire ad essere più dettagliato e preciso, favorendo così la dimunuzione dell'entità degli errori. \\ \hline
    \rowcolor[HTML]{C0C0C0}
