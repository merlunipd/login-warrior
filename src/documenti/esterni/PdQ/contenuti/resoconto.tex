...
\section{Metriche fino allo Sprint 12}
  ...
  \subsection{Verifica dei processi}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.60]{Stima a finire.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.60]{Schedule Variance e Budget Variance.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.60]{Comprensibilità codice.png}
