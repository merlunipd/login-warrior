...
\begin{center}
  ...
  \begin{longtable}{|C{3,5cm}|C{2cm}|C{6,5cm}|}
    ...
    Riccardo Contin & ??? & \cincludegraphics[height=0.035\textheight]{RiccardoContin.png} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    Emanuele Pase & ??? & \cincludegraphics[height=0.03\textheight]{EmanuelePase.png} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    Mattia Zanellato & ??? & \cincludegraphics[height=0.024\textheight]{MattiaZanellato.png} \\ \hline
  \end{longtable}
\end{center}
...
\begin{center}
  ...
  \begin{longtable}{|C{3,5cm}|C{2cm}|C{6,5cm}|}
    ...
    Riccardo Contin & ??? & \cincludegraphics[height=0.035\textheight]{RiccardoContin.png} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    Marco Mamprin & ??? & \cincludegraphics[height=0.04\textheight]{MarcoMamprin.png} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    Marco Mazzucato & ??? & \cincludegraphics[height=0.032\textheight]{MarcoMazzucato.png} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    Lorenzo Onelia & ??? & \cincludegraphics[height=0.04\textheight]{LorenzoOnelia.png} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    Emanuele Pase & ??? & \cincludegraphics[height=0.03\textheight]{EmanuelePase.png} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    Marko Vukovic & ??? & \cincludegraphics[height=0.05\textheight]{MarkoVukovic.png} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    Mattia Zanellato & ??? & \cincludegraphics[height=0.024\textheight]{MattiaZanellato.png} \\ \hline
  \end{longtable}
\end{center}
