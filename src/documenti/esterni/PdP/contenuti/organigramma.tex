...
\begin{center}
  ...
  \begin{longtable}{|C{3,5cm}|C{2cm}|C{6,5cm}|}
    ...
    Emanuele Pase & ??? & \cincludegraphics[height=0.03\textheight]{Emanuele.png} \\ \hline
    \rowcolor[HTML]{EFEFEF}
...
\begin{center}
  ...
  \begin{longtable}{|C{3,5cm}|C{2cm}|C{6,5cm}|}
    ...
    \rowcolor[HTML]{C0C0C0}
    Lorenzo Onelia & ??? & \cincludegraphics[height=0.04\textheight]{Lorenzo.png} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    Emanuele Pase & ??? & \cincludegraphics[height=0.03\textheight]{Emanuele.png} \\ \hline
    \rowcolor[HTML]{C0C0C0}
    Marko Vukovic & ??? & \cincludegraphics[height=0.05\textheight]{Marko.png} \\ \hline
    \rowcolor[HTML]{EFEFEF}
    Mattia Zanellato & ??? & ??? \\ \hline
  \end{longtable}
\end{center}
