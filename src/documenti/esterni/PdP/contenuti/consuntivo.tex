...
\begin{table}[H]
    ...
    \hline
            ...
            \rowcolor[HTML]{C0C0C0}\textit{Marco Mamprin}    & 2.5 (+0.5)   & - (-1)    & 1          & 2 (+2)     & 3           & 2.5 (+0.5)    & 11 (+2)       \\ \hline
            ...
            \rowcolor[HTML]{C0C0C0}\textbf{Totale ore ruolo} & 2.5 (+0.5)   & 2.5 (-2)  & 1          & 15.5 (+2)  & 12 (-0.5)   & 14 (-0.5)     & 47.5 (-0.5)   \\ \hline
    \end{tabular}
    \end{adjustwidth}
...
\begin{table}[H]
    ...
    \rowcolor[HTML]{C0C0C0}\textit{Marco Mamprin}    & 6.5  & 2    & 0     & 14.5  & 16  & 14.5   & 53.5     \\ \hline
    ...
    \rowcolor[HTML]{C0C0C0}\textbf{Totale ore ruolo} & 35.5 & 7    & 1     & 96    & 140 & 96     & 373.5    \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \rowcolor[HTML]{036400}
    \textcolor{white}{\textbf{Ruolo}} & \multicolumn{1}{l|}{\textcolor{white}{\textbf{Ore}}} & \multicolumn{1}{l|}{\textcolor{white}{\textbf{Costo (€)}}} \\ \hline
    \rowcolor[HTML]{EFEFEF}\textit{Responsabile}      & 2.5         & 75                 \\ \hline
    ...
    \rowcolor[HTML]{C0C0C0}\textbf{Totale Consuntivo} & 47.5        & 927.5            \\ \hline
    \rowcolor[HTML]{EFEFEF}\textbf{Differenza}        & -0.5        & +10                \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \rowcolor[HTML]{036400}
    \textcolor{white}{\textbf{Ruolo}} & \multicolumn{1}{l|}{\textcolor{white}{\textbf{Ore}}} & \multicolumn{1}{l|}{\textcolor{white}{\textbf{Costo (€)}}} \\ \hline
    \rowcolor[HTML]{EFEFEF}\textit{Responsabile}      & 35.5            & 1065                 \\ \hline
    ...
    \rowcolor[HTML]{EFEFEF}\textbf{Totale Preventivo} & 373,5           & 7170            \\ \hline
    \end{tabular}
    \caption{Preventivo economico a finire}
\end{table}

\subsubsection{Conclusioni}
In questo breve sprint il team si è impegnato a sistemare i problemi emersi nella valutazione dell'RTB, applicando miglioramenti e correzioni dove necessario. Inoltre è stato svolto uno studio sui grafici non trattati nel \textit{Proof of Concept}, per prepararsi all'imminente progettazione del software.
