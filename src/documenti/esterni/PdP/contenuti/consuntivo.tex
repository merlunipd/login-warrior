...
\begin{table}[H]
    ...
    \rowcolor[HTML]{EFEFEF}\textit{Marko Vukovic}    & 0    & 0    & 0     & 16    & 19  & 11     & 46     \\ \hline
    ...
    \rowcolor[HTML]{C0C0C0}\textbf{Totale ore ruolo} & 35   & 7    & 1     & 96    & 140 & 96     & 375    \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \rowcolor[HTML]{EFEFEF}\textbf{Totale Preventivo} & 375             & 7155            \\ \hline
    \end{tabular}
    \caption{Preventivo economico a finire}
\end{table}
...
\begin{table}[H]
    ...
    \centering
        \begin{tabular}{|l|c|c|c|c|c|c|c|}
            ...
            \rowcolor[HTML]{EFEFEF}\textit{Lorenzo Onelia}   & 4.5      & -          & -          & 2          & 1 (-1)   & 2        & 9.5 (-0.5)       \\ \hline
            \rowcolor[HTML]{C0C0C0}\textbf{Totale ore ruolo} & 4.5      & 4 (-1)     & 0          & 46 (-8)    & 5 (-1)   & 16       & 75.5 (-9.5)       \\ \hline
        \end{tabular}
...
\begin{table}[H]
    ...
    \rowcolor[HTML]{EFEFEF}\textit{Marko Vukovic}    & 0    & 0    & 0     & 6     & 19  & 7      & 32     \\ \hline
    ...
    \rowcolor[HTML]{C0C0C0}\textbf{Totale ore ruolo} & 30.5 & 3    & 1     & 50    & 135 & 80     & 299.5    \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \rowcolor[HTML]{C0C0C0}\textit{Amministratore}    & 4            & 80                 \\ \hline
    \rowcolor[HTML]{EFEFEF}\textit{Analista}          & 0            & 0                 \\ \hline
    \rowcolor[HTML]{C0C0C0}\textit{Progettista}       & 46           & 1150                 \\ \hline
    \rowcolor[HTML]{EFEFEF}\textit{Programmatore}     & 5            & 75                 \\ \hline
...
\begin{table}[H]
    ...
    \rowcolor[HTML]{EFEFEF}\textit{Analista}          & 1               & 25                 \\ \hline
    \rowcolor[HTML]{C0C0C0}\textit{Progettista}       & 50              & 1250                 \\ \hline
    \rowcolor[HTML]{EFEFEF}\textit{Programmatore}     & 135             & 2025                 \\ \hline
    \rowcolor[HTML]{C0C0C0}\textit{Verificatore}      & 80              & 1200                 \\ \hline
    \rowcolor[HTML]{EFEFEF}\textbf{Totale Preventivo} & 299.5           & 5475            \\ \hline
    \end{tabular}
    \caption{Preventivo economico a finire}
\end{table}
...
Il team non è rimasto in linea con quanto preventivato anche se di poche ore. La differenza è di -9.5 ore e -220€. Il budget rimanente infine è di 5475€.
