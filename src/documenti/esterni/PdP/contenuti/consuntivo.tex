...
\begin{table}[H]
    ...
    \centering
        \begin{tabular}{|l|c|c|c|c|c|c|c|}
            ...
            \rowcolor[HTML]{C0C0C0}\textit{Marco Mamprin}    & -         & -          & -          & ???      & ???  & ???         & ???          \\ \hline
            \rowcolor[HTML]{EFEFEF}\textit{Marko Vukovic}    & -         & -          & -          & -        & -       & -           & -           \\ \hline
            \rowcolor[HTML]{C0C0C0}\textit{Mattia Zanellato} & 4         & -        & -          & -        & -       & 1 (-1)           & 5      \\ \hline
            \rowcolor[HTML]{EFEFEF}\textit{Emanuele Pase}    & -         & -          & -          & -        & 2.5 (+1)  & 2 (-0.5)    & 4.5 (-0.5)      \\ \hline
            \rowcolor[HTML]{C0C0C0}\textit{Riccardo Contin}  & -         & -          & -          & -        & 1     & 0 (-2)           & 1 (-2)          \\ \hline
            \rowcolor[HTML]{EFEFEF}\textit{Lorenzo Onelia}   & -         & -          & -          & -        & 2.5       & 2.5       & 5        \\ \hline
            \rowcolor[HTML]{C0C0C0}\textbf{Totale ore ruolo} & ?         & ?          & -          & ? & ? & ? & ?  \\ \hline
        \end{tabular}
    \caption{Distribuzione delle ore per la nona milestone}
\end{table}
