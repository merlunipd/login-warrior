...
Poichè la pianificazione nel dettaglio sarà fatta in un secondo momento, non ci sembra il caso di stilare un preventivo che con ogni probabilità non rispecchierà
la realtà nel momento in cui si andrà a fare un preventivo per ogni periodo pianificato.
